    ...
    <div className={styles['container']}>
      ...
      <section className={styles['container05']}>
        <div className={styles['container06']}>
          ...
          >
            <span className={styles['text06']}>From nothing to something</span>
          </h1>
        ...
        <div className={styles['container07']}>
          <div className={styles['container08']}>
            ...
            />
            <span className={` ${styles['text09']} ${projectStyles['small']} `}>
              ...
              <br></br>
              <span className={styles['text12']}>-NOAA</span>
            </span>
        ...
        <div className={styles['container12']}>
          <div className={styles['container13']}>
            <div className={styles['container14']}>
              <h2
                className={` ${styles['text23']} ${projectStyles['headingOne']} `}
              >
                Work with us
              </h2>
              <p className={` ${styles['text24']} ${projectStyles['lead']} `}>
                <span className={styles['text25']}>
                  Whatever your qualification is - we got you!
                </span>
              </p>
              <p className={` ${styles['text26']} ${projectStyles['body']} `}>
              ...
              <p className={styles['text28']}>Mark Jojansen</p>
              <p className={` ${styles['text29']} ${projectStyles['small']} `}>
      ...
      <section className={styles['Contaier']}>
        <div className={styles['container30']}>
          ...
          <h2
            className={` ${styles['text30']} ${projectStyles['headingTwo']} `}
          >
            <span className={styles['text31']}>Beware The Components</span>
          </h2>
          <h3
            className={` ${styles['text32']} ${projectStyles['headingTwo']} `}
          >
            <span className={styles['text33']}>How To Handle Them</span>
            <br></br>
          </h3>
        ...
        <div className={styles['container32']}>
          <div className={styles['container33']}>
            ...
            <div className={styles['container35']}>
              ...
              <h1
                className={` ${styles['text36']} ${projectStyles['headingOne']} `}
              >
                Search and Discover!
              </h1>
        ...
        <div className={styles['container37']}>
          ...
          <div className={styles['container39']}>
            <div className={styles['container40']}></div>
            <div className={styles['container41']}>
              ...
              <h1
                className={` ${styles['text40']} ${projectStyles['headingOne']} `}
              >
                Talk and Meet!
              </h1>
